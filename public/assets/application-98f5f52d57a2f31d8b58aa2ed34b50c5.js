...
(function() {
  $(function() {
    var instructions, remaining, update_counts;
    ...
    update_counts = function() {
      ...
      return remaining.text(count + " characters remaining");
    };
    $(".order__message input").click(function() {
    ...
    $("#user_role").change(function() {
      if ($("#user_role").val() === 'pcv') {
        return $("#user_pcmo_id").show();
      } else {
        return $("#user_pcmo_id").hide();
      }
    }).change();
    return $("input[name='duration']").daterangepicker({
      format: "YYYY-MM-DD",
      startDate: "2013-01-01",
      endDate: "2013-12-31"
    }, function(start, end) {
      return alert("A date range was chosen: " + start.format("YYYY-MM-DD") + " to " + end.format("YYYY-MM-DD"));
    });
  });
